...
namespace RealSenseManager
{
    ...
    public class RealSenseManagerPc : IColorSource, IRealSenseManager
    {
        ...
        private static RealSenseManagerPc _instance;
        public static RealSenseManagerPc Instance
        {
            get
            {
                if (_instance == null)
        ...
        public static RealSenseManagerPc InitializeInstance()
        {
            if (_instance != null)
            {
            ...
            _instance = new RealSenseManagerPc();
            return _instance;
        }

        public RealSenseManagerPc()
        {
